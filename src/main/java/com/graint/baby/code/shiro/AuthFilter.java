...
/**
 * 此过滤器只有一个目的, 验证token的合法性.
 *
 * <p>这里isAccessAllowed方法只有返回false才会执行onAccessDenied方法,
 ...
 * 使用Base64来加密解密,这样就满足要求了。目前还没有切换成64。</p>
 *
 * <p>2019-05-25更新:使用JWT token来完善目前已有的逻辑，包括代码的改写(老代码截图放在了 截图 文件夹里)</p>
 *
 * <p>2019-09-14更新:使用全局异常处理类,无法捕获Filter中抛出的异常,
 * 具体原因见文章{@see <a href=https://blog.csdn.net/loophome/article/details/94723723></a>}</p>
 */
